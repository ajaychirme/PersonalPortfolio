...
const Services = () => {
  ...
  return (
    <div id='services'>
        <h2>Services</h2>
        <section>
            <motion.div id='serviceBox1' className='"serviceBox1' whileInView={animations.whileInView}
            ...
            <motion.div id='serviceBox4' className='"serviceBox1' whileInView={animations.whileInView}
